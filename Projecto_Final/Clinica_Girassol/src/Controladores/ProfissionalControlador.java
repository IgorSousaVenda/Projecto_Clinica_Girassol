...
public class ProfissionalControlador {
    ...
    @FXML
    private TableColumn<?, ?> tabelaNascimento;
   ...
   @FXML
    ...
    private void inicializarTabela() {
        ...
        tabelaCrm.setCellValueFactory(new PropertyValueFactory<>("Crm"));
    ...
    void Confirmar(ActionEvent event) {
        ...
        novoFuncionario.setDataNascimento(data.getValue());
        ...
        if (checkFuncionario.isSelected()) {
            ...
            novoFuncionario.setCrm( txtCrm.getText());
        }
    ...
    void Adicionar(ActionEvent event) {
        ...
        if (funcionarioSelecionado != null) {
            ...
            if (funcionarioSelecionado.getCargo().equals("Médico")) {
                ...
                txtCrm.setText(funcionarioSelecionado.getCrm());
